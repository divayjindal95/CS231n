...
class Network:
	...
	def feed_forward(self, X):
		...
		for l in xrange(self.num_layers-1):
			#print np.dot(self.weights[l], activations[l])
...
if __name__=="__main__":
	...
	net=Network([3072,100,10],batch_size=20,epoches=10,eta=0.001)
